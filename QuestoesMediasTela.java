...
public class QuestoesMediasTela extends javax.swing.JFrame {
    ...
    int Pontuacao = 0;
    int numeroQuestao = 2;
    int PontuacaoMax = perguntas.size() * 3;
    
    public QuestoesMediasTela() throws Exception {
        initComponents();
        
        perguntas = new QuestoesDAOMedio().obterPerguntas();
   ...
   public ActionListener acao = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (segundos == 60) {
                ...
                ResultadoMedioTela.txtPontuacao.setText("Sua Pontuação: " + Pontuacao + " / " + PontuacaoMax);
    ...
    private void txtAltAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtAltAActionPerformed
        ...
        if (index == perguntas.size()) {
            ...
            ResultadoMedioTela Tr = new ResultadoMedioTela();
            Tr.setVisible(true);

            ResultadoMedioTela.txtPontuacao.setText("Sua Pontuação: " + Pontuacao + " / " + PontuacaoMax);
            ResultadoMedioTela.txtConclusao.setText("Voce concluiu o quiz de Nível Fácil!!");
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(QuestoesMediasTela.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
