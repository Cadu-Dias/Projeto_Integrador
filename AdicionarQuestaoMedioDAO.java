...
public class AdicionarQuestaoMedioDAO {
    ...
    public List <Pergunta> obterTamanho () throws Exception{
            ...
            List <Pergunta> perguntasMedias = new ArrayList <>();
   
            //1. abrir uma conexao com o banco
            Connection conexao = ConnectionFactory.getConnection();
            //2. Executar o comando SELECT com join
            String sql = "select * from perguntas, respostas where perguntas.idPergunta = respostas.idPergunta and exists (select * from perguntas where idResposta Like \"%RM%\") ";
